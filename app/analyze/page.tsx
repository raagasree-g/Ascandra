  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const payload = {
      ...
      financial_information: {
        purchase_cost_per_unit: Number(purchaseCost) || 0,
        selling_price_per_unit: Number(sellingPrice) || 0,
        sales_volume: Number(salesVolume) || 0,
        monthly_operating_expenses: Number(monthlyExpenses) || 0,
        current_cash_balance: Number(cashBalance) || 0,
      },

      credit_information: {
        supplier_amount_owed: Number(supplierOwed) || 0,
        supplier_payment_days: Number(supplierDays) || 0,
        customer_amount_due: Number(customerDue) || 0,
        customer_payment_days: Number(customerDays) || 0,
      },
    };
    ...
    <main className="form-page">
      <div className="form-container">
        <div className="form-header">
          ...
          <p>
            Provide the information you know. Ascandra will use the available
            data and identify what is missing.
          </p>
        </div>
        ...
        <form className="form-card" onSubmit={handleSubmit}>
          ...
          <div className="form-grid">
            ...
            <div className="field">
              <label>Supplier amount owed (₹)</label>
              <input
                type="number"
                min="0"
                value={supplierOwed}
                onChange={(e) => setSupplierOwed(e.target.value)}
              />
            </div>

            <div className="field">
              <label>Supplier payment period (days)</label>
              <input
                type="number"
                min="0"
                value={supplierDays}
            ...
            <div className="field">
              <label>Customer amount due (₹)</label>
              <input
                type="number"
                min="0"
                value={customerDue}
            ...
            <div className="field">
              <label>Customer payment period (days)</label>
              <input
                type="number"
                min="0"
                value={customerDays}
          ...
          <div className="field">
            <label>Tell Ascandra anything else about your business</label>
            <textarea
              value={message}
